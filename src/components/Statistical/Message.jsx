    ...
    useEffect(() => {
        ...
        async function fetchData() { 
            ...
            try {
                ...
                const response = await axios.post("https://backend.karusa.fr/stats/message");
        ...
        if (statsData !== null && statsDataBefore !== null && canvasRef.current) {
            ...
            chartInstanceRef.current = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Nombre de messages envoyés dans la semaine',
                        ...
                        {
                            label: 'Nombre de messages envoyés dans la semaine précédente',
